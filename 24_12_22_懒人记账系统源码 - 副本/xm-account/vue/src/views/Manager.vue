      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            ...
            <el-menu-item index="/notebook">记账日记</el-menu-item>
            <el-menu-item index="/plan">存钱计划</el-menu-item>
            <el-menu-item index="/transferMoney" v-if="user.role === 'USER'">转出记录</el-menu-item>
            <el-menu-item index="/transferTo" v-if="user.role === 'USER'">转入记录</el-menu-item>
            <el-menu-item index="/transferInfo" v-if="user.role === 'ADMIN'">转账记录</el-menu-item>
