/*
 ...
 Source Schema         : 24_12_22_dz_account

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32)
 File Encoding         : 65001

 Date: 22/12/2024 11:06:12
*/
...
-- Records of ac
-- ----------------------------
INSERT INTO `ac` VALUES (4, 4, 500.00, 1100.00, 600.00);
INSERT INTO `ac` VALUES (5, 5, 150.00, 150.00, 0.00);
INSERT INTO `ac` VALUES (8, 2, 200.00, 300.00, 100.00);
...
CREATE TABLE `bill`  (
  ...
  `user_id` int NULL DEFAULT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '账单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `transfer_money`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '转账记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `user` VALUES (4, 'aaa', '123', '小武哥哥', 'http://localhost:9090/files/1702437704985-微信截图_20231018172512.png', 'USER', '13988997791', 'aaa@xm.com', '男', '2023-12-13');
INSERT INTO `user` VALUES (5, 'ccc', '123', '小青哥哥', 'http://localhost:9090/files/1702523483497-微信截图_20231018172452.png', 'USER', '13899287799', 'ccc@xm.com', '男', '2001-12-10');
